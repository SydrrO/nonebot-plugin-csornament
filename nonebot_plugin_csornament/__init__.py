...
__plugin_meta__ = PluginMetadata(
    ...
    homepage="https://githubfast.com/Sydrr0/nonebot-plugin-csornament",
    # 发布必填。
)
...
async def got_name(state: T_State, name: str = ArgPlainText()):
    ...
    try:
        ...
        await search.finish(
            'data.csv未放入指定文件夹\nreadme是不是没看!!!\nhttps://githubfast.com/Sydrro/nonebot-plugin-csornament/tree/main')
